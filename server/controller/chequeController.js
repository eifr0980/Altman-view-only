/* Load Cheque Data Access Object */
...
class ChequeController {
     ...
     * @return entity
     */
    findByResidentId(req, res) {
        let id = req.params.id;

        this.chequeDao.findByResidentId(id)
            .then(this.common.findSuccess(res))
            .catch(this.common.findError(res));
    };
    ...
    findQuery(req, res) {
        ...
        this.chequeDao.findQuery(sqlParams)
            .then(this.common.findSuccess(res))
            .catch(this.common.findError(res));
    };
    ...
    update(req, res) {
        ...
        return this.chequeDao.update(apt)
    ...
    create(req, res) {
        ...
        if (req.body.id) {
            return this.chequeDao.createWithId(apt)
                .then(this.common.editSuccess(res))
                .catch(this.common.serverError(res));
        }
        else {
            return this.chequeDao.create(apt)
                .then(this.common.editSuccess(res))
                .catch(this.common.serverError(res));
        }
